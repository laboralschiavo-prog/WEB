    ...
    <div className="min-h-screen flex">
      <aside className="w-56 bg-gray-900 text-white flex flex-col py-6 shrink-0">
        ...
        <div className="px-4 mt-4 space-y-3">
          <Link
            href="/admin/vista-cliente"
            className="flex items-center gap-2 rounded-md px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition-colors"
          >
          ...
          <form action="/api/logout" method="POST">
            <button className="text-xs text-gray-400 hover:text-white transition-colors px-3">
              Cerrar sesión
            </button>
          </form>
        </div>
